...
fs: bin/BaseCommand.o bin/BaseFile.o bin/CdCommand.o bin/CpCommand.o bin/Directory.o bin/Enviroment.o bin/ErrorCommand.o bin/ExecCommand.o bin/File.o bin/FileSystem.o bin/HistoryCommand.o  bin/main.o bin/MkdirCommand.o bin/MkfileCommand.o bin/MvCommand.o bin/NevigationHelper.o bin/PwdCommand.o bin/RenameCommand.o bin/RmCommand.o bin/VerboseCommand.o bin/VerboseHandler.o bin/LsCommand.o
	@echo 'Building target: fs'
	@echo 'Invoking: C++ Linker'
	$(CC) -o bin/fs bin/BaseCommand.o bin/BaseFile.o bin/CdCommand.o bin/CpCommand.o bin/Directory.o bin/Enviroment.o bin/ErrorCommand.o bin/ExecCommand.o bin/File.o bin/FileSystem.o bin/HistoryCommand.o bin/LsCommand.o bin/main.o bin/MkdirCommand.o bin/MkfileCommand.o bin/MvCommand.o bin/NevigationHelper.o bin/PwdCommand.o bin/RenameCommand.o bin/RmCommand.o bin/VerboseCommand.o bin/VerboseHandler.o $(LFLAGS)
